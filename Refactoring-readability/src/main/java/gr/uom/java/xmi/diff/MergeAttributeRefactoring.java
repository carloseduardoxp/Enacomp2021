...
public class MergeAttributeRefactoring implements Refactoring {
	...
	public Map<String, String> getSourceCodeBeforeRefactoring() {
		...
		for(UMLAttribute mergedAttribute : this.mergedAttributes) {
			result.put(mergedAttribute.getUmlAbstractClass().getName(),mergedAttribute.getUmlAbstractClass().getSourceCodeContent());
		}
		return result;
	}
	...
	public Map<String, String> getSourceCodeAfterRefactoring() {
		Map<String, String> result = new HashMap<>();
		result.put(getNewAttribute().getUmlAbstractClass().getName(),getNewAttribute().getUmlAbstractClass().getSourceCodeContent());
		return result;
	}
