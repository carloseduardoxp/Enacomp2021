...
public class SplitAttributeRefactoring implements Refactoring {
	...
	public Map<String, String> getSourceCodeBeforeRefactoring() {
		...
		result.put(getOldAttribute().getUmlAbstractClass().getName(),getOldAttribute().getUmlAbstractClass().getSourceCodeContent());
		return result;
	}
	...
	public Map<String, String> getSourceCodeAfterRefactoring() {
		Map<String, String> result = new HashMap<>();
		for(UMLAttribute splitAttribute : this.splitAttributes) {
			result.put(splitAttribute.getUmlAbstractClass().getName(),splitAttribute.getUmlAbstractClass().getSourceCodeContent());
		}
		return result;
	}
